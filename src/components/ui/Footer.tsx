export default function Footer() {
  return (
    <footer className="w-full pt-8 bg-burlyWood px-8 lg:px-40 flex flex-col lg:flex-row items-center lg:justify-between shadow-md lg:gap-x-32">
      <div className="w-full h-full flex flex-col lg:flex-row items-center lg:items-start text-light gap-4 lg:order-1 lg:gap-x-32">
        ...
        <div className="lg:order-0">
          <a href="https://www.facebook.com/profile.php?id=61575948515901">
      ...
      <img src="/brandingWhite.png" alt="branding" className="max-w-40 lg:max-w-48 w-[60%]"/>
    </footer>
  )
}